              ...
              case 0:
                ...
                return _context.abrupt("return", fetch(url, {
                  ...
                  if (statusCode == OK) return json;else {
                    ...
                    else return new ErrorObj(BAD_REQUEST_MSG); //custom error message from API              
                  }
                })["catch"](function () {
