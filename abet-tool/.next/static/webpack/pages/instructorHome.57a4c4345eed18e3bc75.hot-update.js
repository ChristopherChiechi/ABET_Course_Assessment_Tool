            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", fetch(url, {
                  ...
                  if (statusCode == OK) return json;else if (statusCode == UNAUTHORIZED) return new ErrorObj(NOT_LOGGED_IN_MSG, false);else return new ErrorObj(json["message"]);
                })["catch"](function () {
